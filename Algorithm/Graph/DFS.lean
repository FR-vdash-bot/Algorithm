...
def dfsForest' [Fintype V] {BoolArray : Type*}
...
lemma roots_dfsForest'_fst_subset [Fintype V] {BoolArray : Type*} [Inhabited BoolArray]
    [AssocArray BoolArray V Bool false] (g : AdjList V EType EColl StarColl)
...
lemma subset_support_toDFinsupp'_dfsForest'_snd [DecidableEq V] [Fintype V] {BoolArray : Type*}
    [Inhabited BoolArray] [AssocArray BoolArray V Bool false] (g : AdjList V EType EColl StarColl)
    (vs : List V) (visited : BoolArray) :
...
def dfsForest [Fintype V] {BoolArray : Type*} [Inhabited BoolArray]
...
lemma dfsForest_spec' [Fintype V] (BoolArray : Type*) [Inhabited BoolArray]
    [AssocArray BoolArray V Bool false] (g : AdjList V EType EColl StarColl) (vs : List V) :
...
def dfs' [Fintype V] {BoolArray : Type*} [Inhabited BoolArray] [AssocArray BoolArray V Bool false]
    (g : AdjList V EType EColl StarColl) (vs : List V) (visited : BoolArray) :
...
def dfsForestTR [Fintype V] {BoolArray : Type*} [Inhabited BoolArray]
    [AssocArray BoolArray V Bool false]
...
def dfs'TR [Fintype V] {BoolArray : Type*} [Inhabited BoolArray] [AssocArray BoolArray V Bool false]
...
def dfsTR [Fintype V] {BoolArray : Type*} [Inhabited BoolArray] [AssocArray BoolArray V Bool false]
    (g : AdjList V EType EColl StarColl) (vs : List V) (visited : BoolArray) :
    BoolArray :=
  match vs with
  | [] => visited
...
lemma dfsTR_spec [Fintype V] (BoolArray : Type*) [Inhabited BoolArray]
    [AssocArray BoolArray V Bool false]
